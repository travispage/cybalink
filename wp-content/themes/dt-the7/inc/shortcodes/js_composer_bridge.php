...
vc_map( array(
	...
	"params" => array(
		 ...
		 * @see: inc/shortcodes/includes/button/button.php
		 *
		array(
			...
			'value' => array(
				__( 'HTML', 'the7mk2' ) => 'html',
				__( 'Ultimate Addons Icons', 'the7mk2' ) => 'ult',
				__( 'Font Awesome', 'the7mk2' ) => 'fontawesome',
				__( 'Open Iconic', 'the7mk2' ) => 'openiconic',
				__( 'Typicons', 'the7mk2' ) => 'typicons',
				__( 'Entypo', 'the7mk2' ) => 'entypo',
				__( 'Linecons', 'the7mk2' ) => 'linecons',
				__( 'Mono Social', 'the7mk2' ) => 'monosocial',
				__( 'Material', 'the7mk2' ) => 'material',
			),
			'admin_label' => true,
			'param_name' => 'icon_type',
			'description' => __( 'Select icon library.', 'the7mk2' ),
		),
		*/
		array(
			"group" => __("Icon", 'the7mk2'),
