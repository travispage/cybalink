	              ...
	              this.state.files.map(function (file) {
	                return _react2.default.createElement(
	                  ...
	                  _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                      'a',
	                      { target: '_blank', href: FC_1.baseurl + '?formcraft3_download_file=' + file.uniq_key },
	                      file.name
	                    )
	                  ),
	                  _react2.default.createElement(
	    ...
	    render: function render() {
	      return _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          ...
	          _react2.default.createElement(
	            'span',
	            { style: { width: '36.3%', float: 'right' }, className: 'sortable', onClick: this.props.onSort.bind(null, 'created') },
	            'Received',
	            ...
	            this.props.forms.map(function (form) {
	              return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                  'span',
	                  { style: { width: '10%' } },
	                  _react2.default.createElement('i', { 'data-id': form.id, onClick: _this3.props.onTrash.bind(null, form.id), className: 'trash-icon trash-form icon-trash-1' })
	                )
	              );
	            })
	          )
